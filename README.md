...
<ul>
  <li>
    <b>BEM. </b>The project follows the BEM methodology for structuring CSS, where each component is broken down into blocks, elements, and modifiers. This approach ensures that the code is modular, scalable, and easy to maintain.
  </li>
  <li>
